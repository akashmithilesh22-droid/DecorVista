  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="mb-4">Tell Us About Your Space</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          <h3 className="mb-6">Select Room Type</h3>
            ...
            {roomOptions.map((room) => (
              <button
                ...
                className={`relative overflow-hidden rounded-lg border-2 transition-all hover:scale-105 ${
                  inputs.roomType === room.value ? 'ring-2' : ''
                }`}
                style={{
                ...
                <div className="aspect-square">
                  ...
                  <div
                    className={`absolute inset-0 flex items-center justify-center ${
                      inputs.roomType === room.value ? 'bg-black/40' : 'bg-black/20'
                    }`}
                  >
                    <span className="text-white text-center px-2">{room.label}</span>
                  </div>
                </div>
              </button>
            ))}
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          <div className="flex items-center space-x-2 mb-6">
            <Ruler className="w-6 h-6" style={{ color: 'var(--color-primary)' }} />
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              />
              <div className="flex justify-between text-sm mt-1" style={{ color: 'var(--color-text-light)' }}>
                <span>5 m²</span>
                <span>{inputs.dimensions} m²</span>
                <span>100 m²</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          <div className="flex items-center space-x-2 mb-6">
            <CloudRain className="w-6 h-6" style={{ color: 'var(--color-primary)' }} />
            <h3>Climate Type</h3>
          </div>
            ...
            {climateOptions.map((climate) => (
              <button
                ...
                className={`text-left p-4 rounded-lg border-2 transition-all hover:shadow-md ${
                  inputs.climate === climate.value ? 'ring-2' : ''
                }`}
                style={{
              ...
              >
                <h4 className="mb-1">{climate.label}</h4>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg">
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-between text-sm mt-1" style={{ color: 'var(--color-text-light)' }}>
                <span>₹10,000</span>
                <span className="font-medium">₹{inputs.budget.toLocaleString('en-IN')}</span>
                <span>₹5,00,000</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="px-12 py-4 rounded-lg transition-all hover:scale-105 shadow-lg text-lg"
            style={{
